...
~/iris/ai.knowledge/rules/Livekit-protocol/INDEX.md  (if exists)
~/iris/ai.knowledge/knowledge/global/INDEX.md
~/iris/ai.knowledge/knowledge/Livekit-protocol/INDEX.md  (if exists)
```
...
Agent mistake → `/iris-rule global|Livekit-protocol {rule}`
Explained something new → `/iris-learn global|Livekit-protocol {context}`
