...
type IngressInfo struct {
	...
	SessionEnabled      *bool                `protobuf:"varint,16,opt,name=session_enabled,json=sessionEnabled,proto3,oneof" json:"session_enabled,omitempty"` // whether the ingress is enabled, if false, the ingress will not publish to the room
}
...
type UpdateIngressRequest struct {
	...
	Audio             *IngressAudioOptions `protobuf:"bytes,6,opt,name=audio,proto3" json:"audio,omitempty"`
	Video             *IngressVideoOptions `protobuf:"bytes,7,opt,name=video,proto3" json:"video,omitempty"`
	SessionEnabled    *bool                `protobuf:"varint,11,opt,name=session_enabled,json=sessionEnabled,proto3,oneof" json:"session_enabled,omitempty"` // whether the ingress is enabled, if false, the ingress will not publish to the room
}
...
func (x *UpdateIngressRequest) GetSessionEnabled() bool {
	if x != nil && x.SessionEnabled != nil {
		return *x.SessionEnabled
	}
	return false
...
var file_livekit_ingress_proto_rawDesc = []byte{
	...
	0x0a, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x61, 0x74, 0x65, 0x22, 0xbb, 0x04, 0x0a, 0x14,
	...
	0x6e, 0x73, 0x52, 0x05, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x2c, 0x0a, 0x0f, 0x73, 0x65, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x18, 0x0b, 0x20, 0x01,
	0x28, 0x08, 0x48, 0x02, 0x52, 0x0e, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x45, 0x6e, 0x61,
	0x62, 0x6c, 0x65, 0x64, 0x88, 0x01, 0x01, 0x42, 0x15, 0x0a, 0x13, 0x5f, 0x62, 0x79, 0x70, 0x61,
	...
	0x6f, 0x64, 0x69, 0x6e, 0x67, 0x42, 0x12, 0x0a, 0x10, 0x5f, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x22, 0x50, 0x0a, 0x12, 0x4c, 0x69, 0x73,
